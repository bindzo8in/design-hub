  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1600px] px-6 sm:px-12 testi-content">
        ...
        <h2 className="font-heading font-bold text-xs uppercase tracking-[0.3em] text-accent mb-20 flex items-center gap-4">
            ...
            <CarouselContent>
              {displayTestimonials.map((item, idx) => (
                <CarouselItem key={idx} className="flex flex-col items-center justify-center text-center pb-8">
                  <h3 className="font-heading  text-[clamp(1.5rem,3vw,3rem)] leading-[1.3] text-foreground/90 mb-12">
                    "{item.text}"
                  </h3>
