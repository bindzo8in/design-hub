      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end mb-12 lg:mb-16">
          <div>
            ...
            <h2 className="portfolio-header-reveal font-[family-name:var(--font-bebas-neue)] text-5xl sm:text-7xl lg:text-8xl leading-[0.9] uppercase text-slate-900 dark:text-white tracking-wide">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-64 w-full overflow-hidden bg-slate-900">
                    {imageSrc ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-slate-900 via-[#101735] to-slate-950 p-6 text-center">
                        <span className="font-[family-name:var(--font-bebas-neue)] text-3xl uppercase tracking-wider text-slate-600">
                          {project.title}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="flex flex-1 flex-col justify-between p-6">
                    <div>
                      <h3 className="font-[family-name:var(--font-bebas-neue)] text-2xl sm:text-3xl text-white tracking-wide uppercase transition-colors group-hover:text-accent">
                        {project.title}
                      </h3>
