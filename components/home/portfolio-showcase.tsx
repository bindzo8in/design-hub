      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end mb-12 lg:mb-16">
          <div>
            ...
            <h2 className="portfolio-header-reveal font-heading font-bold text-5xl sm:text-7xl lg:text-8xl leading-[0.9] uppercase text-slate-900 dark:text-white tracking-wide">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col justify-between p-6">
                    <div>
                      <h3 className="font-heading font-bold text-2xl sm:text-3xl text-white tracking-wide uppercase transition-colors group-hover:text-accent">
                        {project.title}
                      </h3>
