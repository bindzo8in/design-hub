      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="family-header-trigger mb-14 lg:mb-16 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          <div className="max-w-2xl space-y-4">
            ...
            <h2 className="family-header-reveal font-[family-name:var(--font-heading)] font-light text-5xl sm:text-6xl lg:text-7xl leading-[0.9] tracking-wider uppercase text-foreground">
              {title}
            </h2>
          ...
          <div className="family-header-reveal flex-shrink-0 flex items-center gap-3 rounded-2xl border border-border bg-card/60 px-5 py-4">
            ...
            <div>
              <div className="font-[family-name:var(--font-heading)] font-light text-3xl text-foreground leading-none">
                {members.length}+
              </div>
