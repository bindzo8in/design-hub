        ...
        <header className="mb-16 lg:mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="font-[family-name:var(--font-heading)] font-light uppercase leading-[0.88] tracking-tight text-foreground text-[clamp(3.5rem,10vw,8rem)]">
            ...
            <div className="lg:col-span-5">
              <div className="grid grid-cols-3 gap-4">
                {stats.map((stat, i) => (
                  ...
                  >
                    <div className="font-[family-name:var(--font-heading)] font-light text-4xl sm:text-5xl text-foreground leading-none">
                      <span
