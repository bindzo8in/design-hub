      ...
      >
        ...
        >
          ...
          >
            {/* quick links */}
            <div>
              <h2 className="mb-5 text-xl font-heading font-bold">Quick Links</h2>
            ...
            {/* features */}
            <div>
              <h2 className="mb-5 text-xl font-heading font-bold">Our Features</h2>
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <h2 className="mb-5 text-xl font-heading font-bold">Contact Us</h2>
