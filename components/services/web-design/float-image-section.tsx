...
const images = [
  "/service/web-dev/1.webp",
  "/service/web-dev/2.webp",
  "/service/web-dev/3.webp",
  "/service/web-dev/4.webp",
  "/service/web-dev/5.webp",
  "/service/web-dev/6.webp",
  "/service/web-dev/7.webp",
];
  ...
  return (
    <section className="relative overflow-hidden bg-[#050711] py-24">
      ...
      <div className="mb-8 overflow-hidden">
        <div className="animate-marquee-x flex gap-8 w-max">
          {row1.map((src, index) => (
            <div
              key={index}
              className="
      ...
      <div className="overflow-hidden">
        <div className="animate-marquee-x-reverse flex gap-8 w-max">
          {row2.map((src, index) => (
            <div
              key={index}
              className="
