                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-baseline gap-6">
                        ...
                        <h3 className={cn(
                          "font-heading font-bold text-4xl uppercase tracking-wide transition-all duration-500",
                ...
                >
                  <div className="w-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <h3 className={cn(
                        "font-heading font-bold text-2xl uppercase tracking-wide transition-colors duration-300",
