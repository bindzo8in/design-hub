...
import { useProjectsQuery, useDeleteProjectMutation } from "@/features/projects/hooks/use-projects-query";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-[#101735]/40 border border-[#26336F]/20 p-6 rounded-3xl backdrop-blur-xl">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Track and modify client deliverables, timelines, statuses, and budgeting.
          </p>
        </div>
        <Button
          asChild
        ...
        <AlertDialogContent className="bg-[#101735] border border-[#26336F]/30 text-white rounded-2xl max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-slate-400 text-sm">
              This action cannot be undone. This will permanently delete the project's record and deliverables from the system.
            </AlertDialogDescription>
          </AlertDialogHeader>
