...
import { useTestimonialQuery, useUpdateTestimonialMutation } from "@/features/testimonials/hooks/use-testimonials-query";
...
export default function EditTestimonialPage() {
  ...
  const { data: testimonial, isLoading, error } = useTestimonialQuery(id);
  const updateMutation = useUpdateTestimonialMutation(id);
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-slate-400 text-xs mt-0.5">
            Modify client name, role, quote text, and avatar asset.
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#101735]/40 border border-[#26336F]/20 p-8 rounded-3xl backdrop-blur-xl shadow-2xl">
        {isLoading ? (
          ...
          <div className="text-center py-8 text-[#DF1B25]">
            <p className="font-semibold text-lg">Error loading testimonial details</p>
            ...
            defaultValues={{
              ...
              avatarUrl: testimonial.avatarUrl
                ? {
                    ...
                    publicId: testimonial.avatarPublicId ?? "",
                  }
                : null,
            }}
