...
import { getClientColumns } from "@/features/clients/components/client-columns";
import { useClientsQuery, useDeleteClientMutation } from "@/features/clients/hooks/use-clients-query";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-[#101735]/40 border border-[#26336F]/20 p-6 rounded-3xl backdrop-blur-xl">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Maintain accounts, official links, logos, and profiles for client organizations.
          </p>
        </div>
        <Button
          asChild
        ...
        <AlertDialogContent className="bg-[#101735] border border-[#26336F]/30 text-white rounded-2xl max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-slate-400 text-sm">
              This action cannot be undone. Deleting this client profile will unassign it from all associated projects (without deleting the projects themselves).
            </AlertDialogDescription>
          </AlertDialogHeader>
