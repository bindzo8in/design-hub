          ...
          {session ? (
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-8">
                You are currently accessing this route as an anonymous visitor. Please authenticate using one of the OAuth providers below to initialize a secure session.
              </p>
              ...
              <div className="space-y-4">
                ...
                <form
                  action={async () => {
                    "use server";
                    await signIn("github", { redirectTo: "/auth-demo" });
                  }}
                >
                  <button
                    type="submit"
                  ...
                  >
                    <svg className="w-5 h-5 fill-white group-hover:scale-105 transition-transform duration-300" viewBox="0 0 24 24">
