  ...
  return (
    <main>
      <HeroSection
        ...
        heading="When Your Message Travels, Your Brand Grows"
        description="When People Slow Down, Our Brand Stands Out, Creating Strong Visibility And Instant Recall."
