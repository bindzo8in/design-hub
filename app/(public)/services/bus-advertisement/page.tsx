  ...
  return (
    <main>
      <HeroSection
        ...
        heading="Your Brand On The Move..."
        description="Bus Advertising Carries Our Message Across The City, Creating Nonstop Visibility And Strong Brand Recall."
