    ...
    <div className="flex flex-col sm:flex-row items-center gap-6 justify-between w-full">
      <Button
        ...
        className={`gap-2 rounded-full border-2 ${
          isLiked 
            ? "border-[#DF1B25] text-[#DF1B25] hover:bg-[#DF1B25]/10 hover:text-[#DF1B25]" 
            : "border-border text-muted-foreground hover:text-foreground"
        }`}
        onClick={() => setIsLiked(!isLiked)}
      >
        <Heart className={`w-5 h-5 ${isLiked ? "fill-[#DF1B25]" : ""}`} />
      ...
      <div className="flex items-center gap-3">
        ...
        <a
          ...
          className="w-10 h-10 rounded-full bg-muted flex items-center justify-center hover:bg-muted/80 text-foreground transition-colors"
          title="Share on X"
        >
          <svg viewBox="0 0 24 24" aria-hidden="true" className="w-4 h-4 fill-current">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 24.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.007 4.15H5.078z"></path>
          </svg>
        </a>
